    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
             ...
             <div class="form-group" id="formImgDiv">
                <img src="http://via.placeholder.com/150x150" class="img-thumbnail" alt="Item's image">
                <input type="file" id="formImgInput" accept=".jpg, .jpeg, .png" name="Rodz">
            </div>
        </div>
